  ...
  <section id="alquimista" className="py-32 px-4 bg-brand-950 text-white relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto rounded-[3.5rem] border border-white/5 bg-brand-900/40 backdrop-blur-3xl p-6 sm:p-12 md:p-24 shadow-2xl relative z-10 text-center">
      ...
      <h2 className="text-3xl sm:text-5xl md:text-8xl font-serif font-black leading-none tracking-tighter text-white">
        Alquimia en <br />
        <span className="text-yolk-500 italic">Tu Cocina.</span>
      </h2>
      <p className="mt-8 text-lg sm:text-2xl md:text-4xl font-serif italic text-white/90 max-w-4xl mx-auto leading-[1.3]">
        “Fusionamos <span className="text-yolk-400 not-italic font-black">Nuestros Tesoros</span> con lo que tienes en casa para crear salud y sabor real.”
      </p>
      <div className="mt-14 flex flex-col items-center gap-6">
        ...
        >
          Entrar a la Alquimia <ArrowRight className="inline-block ml-2" size={18} />
        </button>
        <p className="text-white/40 text-[10px] font-black uppercase tracking-[0.5em]">Acceso Reservado • Miembros del Nido</p>
      </div>
    </div>
  </section>
);
