              ...
              {!isChefUnlocked ? (
                ...
                <div id="receta-menu-alquimista" className="p-8 md:p-16 space-y-12 bg-white/5 backdrop-blur-3xl shadow-[0_0_80px_rgba(0,0,0,0.5)] rounded-[3.8rem] border border-white/10 z-10 relative mt-16 w-full">
                  ...
                  <div className={cn(
                    ...
                    (chefResult || chefFallbackText) ? "bg-white border-2 border-stone-100 shadow-xl" : "bg-beige-50/50 border-2 border-dashed border-stone-200 flex flex-col items-center justify-center text-center px-10"
                  )}>
                      ...
                      <div className="w-full animate-in fade-in slide-in-from-bottom-8 duration-1000 -m-10 md:-m-14">
                        ...
                        <div className="relative rounded-[2rem] overflow-hidden bg-gradient-to-br from-stone-900 via-brand-950 to-stone-900 lg:-mx-14 lg:-mt-14 mb-10 shadow-premium-xl">
                          ...
                          <div className="relative z-10 p-10 md:p-20 flex flex-col items-center justify-center text-center space-y-6">
                            ...
                            <h3 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif font-black text-amber-50 leading-[1.1] drop-shadow-2xl px-4">
                              {chefResult.title}
                            </h3>
                            <div className="w-24 h-1 bg-gradient-to-r from-transparent via-brand-500 to-transparent opacity-60 mt-4 mx-auto rounded-full"></div>
                          </div>
                        </div>
