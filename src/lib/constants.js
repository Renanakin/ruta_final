...
export const PRODUCTS = [
  ...
  {
    id: 4,
    name: 'Queso Mantecoso de Licanray Pieza de 500g',
    category: 'quesos',
    ...
    badge: 'Artesanal Sur',
    inStock: true,
    extendedDescription: 'Queso mantecoso artesanal producido en Licanray. Caracterizado por su suavidad y proceso tradicional. Ideal para tablas, sándwiches o simplemente disfrutar solo.',
  ...
  },
  {
    ...
    inStock: true,
    extendedDescription: 'Queso mantecoso tradicional de exportación. Seleccionado uno a uno por su maduración perfecta. El sabor real del sur en formato individual.',
