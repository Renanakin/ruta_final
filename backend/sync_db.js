...
const PRODUCTS = [
  ...
  },
  {
    ...
    badge: 'Extra Grande',
    inStock: true,
    extendedDescription: 'Nuestro "Huevo Extra" se caracteriza por su gran tamaño y frescura garantizada. Con un peso de entre 61 y 68 gramos por unidad, ofrece un mayor contenido nutricional y de yema por unidad. *Promoción Especial: 10% de descuento en la compra por caja (6 bandejas).',
  ...
  {
    id: 4,
    name: 'Que mantecoso de Licanray Pieza de 500g',
    category: 'quesos',
    ...
    badge: 'Artesanal Sur',
    inStock: true,
    extendedDescription: 'Queso mantecoso artesanal producido en Licanray. Caracterizado por su suavidad y proceso tradicional. Ideal para tablas, sandwich o simplemente disfrutar solo.',
    nutrition: ['359 Kcal Energia por 100g', '24.0g Proteina por 100g', '26.0g Grasas por 100g', 'Sodio: 1.8%'],
    origin: 'Licanray, IX Región, Chile',
    reviews: [
  ...
  {
    id: 6,
    name: 'Queso Mantecoso Tradicional (Horma)',
    category: 'quesos',
    description: 'Nuestra horma individual de queso mantecoso. Sabor puro y textura artesanal en formato compacto.',
    price: 6800,
    image: '/images/QUESO_RUEDA_FINAL.jpg',
    badge: 'Selección Nido',
    inStock: true,
    extendedDescription: 'Queso mantecoso tradicional de exportacion. Seleccionado uno a uno por su maduracion perfecta. El sabor real del sur en formato individual.',
...
async function syncDb() {
  ...
  const stmt = await db.prepare(
    'INSERT INTO products (id, name, description, price, image, badge, in_stock, extended_description, nutrition, origin, reviews, category) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)'
  );
