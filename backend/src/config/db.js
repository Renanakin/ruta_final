  ...
  initPromise = (async () => {
    ...
    await db.exec(`
      ...
      (8, 'Huevo Blanco Extra (Bandeja 30 un)', 'huevos',
        ...
        'Nuestro "Huevo Extra" se caracteriza por su gran tamaño y frescura garantizada. Con un peso de entre 61 y 68 gramos por unidad, ofrece un mayor contenido nutricional y de yema por unidad. *Promoción Especial: 10% de descuento en la compra por caja (6 bandejas).',
      ...
      (4, 'Queso Mantecoso de Licanray Pieza de 500g', 'quesos',
        'Queso artesanal directamente de la zona sur del país. Textura mantecosa y sabor auténtico.',
        8990, '/images/QUESO_LICANRAY_FINAL.jpg', 'Artesanal Sur', 1,
        'Queso mantecoso artesanal producido en Licanray. Caracterizado por su suavidad y proceso tradicional. Ideal para tablas, sándwiches o simplemente disfrutar solo.',
        '["359 Kcal Energía por 100g","24.0g Proteína por 100g","26.0g Grasas por 100g","Sodio: 1.8%"]',
        'Licanray, IX Región, Chile',
        '["El sabor del sur en mi casa, espectacular.","Muy cremoso, se nota la diferencia artesanal.","Calidad superior, 100% recomendado."]'),
      (6, 'Queso Mantecoso Tradicional (Horma)', 'quesos',
        'Nuestra horma individual de queso mantecoso. Sabor puro y textura artesanal en formato compacto.',
        6800, '/images/QUESO_RUEDA_FINAL.jpg', 'Selección Nido', 1,
        'Queso mantecoso tradicional de exportación. Seleccionado uno a uno por su maduración perfecta. El sabor real del sur en formato individual.',
      ...
      (7, 'Longaniza Artesanal de Contulmo (Baja en Grasa)', 'embutidos',
        ...
        10800, '/images/LONGANIZA_CONTULMO.jpg', 'Referencia $10.800/kg', 1,
      ...
      (2, 'Salmón porcionado 500g', 'congelados',
        ...
        8000, '/images/SALMON_PREMIUM_BAG.png', 'Contenido 500g', 1,
